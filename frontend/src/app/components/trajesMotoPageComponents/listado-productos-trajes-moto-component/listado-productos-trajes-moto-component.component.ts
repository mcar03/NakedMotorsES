...
@Component({
  selector: 'app-listado-productos-trajes-moto-component',
  templateUrl: './listado-productos-trajes-moto-component.component.html',
  styleUrls: ['./listado-productos-trajes-moto-component.component.css']
})
export class ListadoProductosTrajesMotoComponentComponent {
  ...
  ngOnInit(): void {
    this.productoService.obtenerProductos().subscribe(data => {
      this.productos = data
        .filter(p => p.categoriaNombre === 'Monos')
        .map(p => ({ ...p, liked: false }));
